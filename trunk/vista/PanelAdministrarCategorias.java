...
import vista.modeloTablas.ModeloTablaCategoria;

/**
 *
 * @author Alex
 */
public class PanelAdministrarCategorias extends javax.swing.JPanel {
    private ServicioCategoria sm = new ServicioCategoria();
    private ModeloTablaCategoria modelo = new ModeloTablaCategoria();
    /**
     * Creates new form PanelAdministrarMarcas
     */
    public PanelAdministrarCategorias() {
        initComponents();
        cargarTabla();
    }
    ...
    private void cargarObjeto(){
        sm.getCategoria().setNombre_categoria(txtNombreMarca.getText());        
    }
    private void cargarVista(){
        txtNombreMarca.setText(sm.getCategoria().getNombre_categoria());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Crear Nueva Categoria"));

        jLabel1.setText("Ingrese el Nombre de la Categoriia:");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if(Utilidades.requerido(txtNombreMarca, txtNombreMarca.getText())==true){
            cargarObjeto();
            if(sm.getCategoria().getId_categoria()==null){
                if(sm.guardar()==true){
    ...
    private void btnEliminarMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarMarcaActionPerformed
        ...
        if(fila >=0){
            sm.fijarInstancia(modelo.getLista().get(fila));
            boolean aux = (sm.getCategoria().isEstado_categoria()==true)?false:true;
            sm.getCategoria().setEstado_categoria(aux);
            sm.guardar();
